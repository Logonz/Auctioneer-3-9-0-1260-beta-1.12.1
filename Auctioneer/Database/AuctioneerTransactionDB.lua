--[[
	...
	Revision: $Id: AuctioneerTransactionDB.lua 1248 2006-12-26 16:39:47Z mentalpower $
...
function onEventHook(hookArgs, event)--, ...) Removed the last part seems not to be needed?
